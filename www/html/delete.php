...
<body>
    ...
    <div class="container">
        ...
        <a class='btn small pull-right' href='create-form.p hp'> Crear nuevo ➕</a>
        <div>
            <p>Buscar por:</p>
            <br />
            <?php
        ...
        <table class="table">
            <tr>
                ...
                <th class="center-div">Teléfono</th>
            ...
            foreach ($people as $person) {
                echo '<tr>
                        ...
                        <td class="center-div">' . $person["phone"] . '</td>
                        <td class="center-div">' . $person["address_line1"] . '(' . $person["address_line2"] . ')' . '</td>
                        <td class="center-div">|<a href="edit-form.php?id=' . $person["id"] . '">Editar ✍</a> | <a href="/php/person/delete.php?id=' . $person["id"] . '">Borrar ❌</a>|</td>
                    </tr>';
            }
